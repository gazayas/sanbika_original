...
var CHORD_REGEXP = /[A-G]{1,1}/; // TODO: sharp_or_flat_is_present_in(str)
...
$(document).ready(function () {
  ...
  for (var z = 0; z < song_bodies.length; z++) {
    ...
    for (var i = 0; i < song_body.length; i++) {
      ...
      var str_ary = song_body[i].split(/(\s+|　+)/); // TODO: Refactor this expression, make it into its own function.

      for (var x = 0; x < str_ary.length; x++) {
        if (/\s+|　+/.test(str_ary[x]) || str_ary[x] == "") {// Goes on to the next value if there is a space
...
/******/ });
//# sourceMappingURL=initialize_song-04fd7752662f579d106f.js.map