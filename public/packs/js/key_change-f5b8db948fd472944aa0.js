...
console.log("set list"); // Decipher whether it's song#show or set_list#show
// TODO: Make this more readable

if (/\//.test($('#key_box').val()) == false) {
  $(function () {
    return $('#key_box').on('change', function () {
      return key_change($('#key_box').attr('class'), null);
    });
  });
} else if ($('#set_list_title').val() == "") {
...
/******/ });
//# sourceMappingURL=key_change-f5b8db948fd472944aa0.js.map