...
$(document).ready(function () {
  ...
  $.each(song_bodies, function (i) {
    ...
    var song_body = song_body_lines.join("<br>"); // TODO: Look into what's going on here and refactor this next line

    console.log(song_body); //song_body = song_body.replace(/^<br>\s{2,2}/, "");
...
/******/ });
//# sourceMappingURL=initialize_song-a7dc26e5b1bb5f86662d.js.map