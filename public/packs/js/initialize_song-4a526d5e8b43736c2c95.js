...
$(document).ready(function () {
  ...
  for (var z = 0; z < song_bodies.length; z++) {
    ...
    for (var i = 0; i < song_body.length; i++) {
      var str_ary = song_body[i].split(WHITE_SPACE_REGEXP); // If the array of strings consists of chords (as opposed to lyrics),
...
/******/ });
//# sourceMappingURL=initialize_song-4a526d5e8b43736c2c95.js.map