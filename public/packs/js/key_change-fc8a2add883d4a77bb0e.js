...
if (set_list_songs.length == 0) {
  ...
  for (i = 0; i < song_bodies.length; i++) {
    ...
    var new_key = keys[1];
    $(function () {
      return $('.set_list_song').on('load', console.log("hello") // key_change(original_key, null, new_key, song_bodies[i])
      );
    });
  }
}
...
/******/ });
//# sourceMappingURL=key_change-fc8a2add883d4a77bb0e.js.map