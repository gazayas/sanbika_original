...
function get_song_body_chords(ary) {} // Find how many steps the key change is.
// One chromatic half step is handled as a difference of 1.


function get_difference() {} // TODO: Write original_key instead of old_key,
...
function key_change(old_key, slash_chords) {
  ...
  return function (new_key) {
    ...
    var difference;
    var chord_strings = [];
    var new_chords = []; // If a slash chord has been passed to the function, use the string as is.
    // Otherwise, pull the chord from its span element.

    if (slash_chords) {
      chord_strings = slash_chords;
      console.log(slash_chords);
    } else {
...
/******/ });
//# sourceMappingURL=key_change-d37eec9f76b5fa37b55f.js.map