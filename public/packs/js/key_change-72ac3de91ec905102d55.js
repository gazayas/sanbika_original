...
if (set_list_songs.length == 0) {
  ...
  for (i = 0; i < song_bodies.length; i++) {
    ...
    var new_key = keys[1];
    console.log(song_bodies[i]);
    $(function () {
      return $('.set_list_song').on('load', key_change(original_key, null, new_key, song_bodies[i]));
    });
  }
}
...
/******/ });
//# sourceMappingURL=key_change-72ac3de91ec905102d55.js.map