...
if (set_list_songs.length == 0) {
  console.log(set_list_songs);
  $(function () {
    return $('#key_box').on('change', function () {
      return key_change($('#key_box').attr('class'), null);
    });
  });
} else {
  console.log("set list"); // set list:
  ...
  console.log(song_bodies[0]);

  for (var q = 0; q < song_bodies.length; q++) {// console.log("q is equal to " + q);
    // var keys = song_bodies[q].value.split("/");
    // console.log(keys);
    ...
    $(() =>
      $('.song_body').on(
          'load',
          () => key_change($('#key_box').attr('class'), null)
      )
    );
    */
  }
...
/******/ });
//# sourceMappingURL=key_change-44eefaf800b31d6d3209.js.map