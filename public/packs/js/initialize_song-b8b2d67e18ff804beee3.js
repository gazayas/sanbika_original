...
$(document).ready(function () {
  ...
  for (var z = 0; z < song_bodies.length; z++) {
    ...
    for (var i = 0; i < song_body.length; i++) {
      ...
      var has_chords = has_chords(str_ary); // If the array of strings consists of chords (as opposed to lyrics),
...
/******/ });
//# sourceMappingURL=initialize_song-b8b2d67e18ff804beee3.js.map