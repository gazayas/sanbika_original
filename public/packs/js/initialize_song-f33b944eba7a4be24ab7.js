...
$(document).ready(function () {
  ...
  for (var x = 0; x < song_bodies.length; x++) {
    var song_body = song_bodies[x].innerHTML.split(/\r*\n/);

    for (var i = 0; i < song_body.length; i++) {
      var str_ary = song_body[i].split(WHITE_SPACE_REGEXP);
    ...
    song_bodies[x].innerHTML = song_body;
  }
...
/******/ });
//# sourceMappingURL=initialize_song-f33b944eba7a4be24ab7.js.map