...
function key_change(old_key, slash_chords) {
  ...
  return function (new_key) {
    console.log("hey yooo " + song_body);
...
if (set_list_songs.length == 0) {
  ...
  for (i = 0; i < song_bodies.length; i++) {
    ...
    var new_key = keys[1];
    $(function () {
      return $('.set_list_song').on('load', function () {
        return key_change(original_key, null, new_key, song_bodies[i]);
      });
    });
  }
}
...
/******/ });
//# sourceMappingURL=key_change-eeec34a10bc672160e66.js.map